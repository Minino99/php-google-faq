...
<body>
 <div class="border-bottom sticky-top py-3 mb-5 bg-white">
  <div class="container-fluid d-flex justify-content-between align-items-center" style="height: 50px;">
   <div class="h-100"><img class="h-100" src="img/logo.png"></div>
   <div class="h-100"><img class="h-100 rounded-circle" src="https://lh3.googleusercontent.com/ogw/ADea4I6CoBexXrm4ljuIp_qyP2zcfNgidEo9wu0GqvcGmGE=s32-c-mo"></div>
  </div>
 </div>
 ...
 <div class="container px-5">
  ...
  <?php foreach ($db as $question) { ?>
   ...
   <<?php echo $question["title"]["tag"] ?> class="py-5"> <?php echo $question["title"]["text"] ?> </<?php echo $question["title"]["tag"] ?>>

   <?php foreach ($question["content"] as $paragraph) { 
